...
# 	command "#{base_path}/public/framework/sake MobileSettingsCacheTask"
# end

every 1.minute do
  command "#{base_path}/public/framework/sake dev/tasks/ProcessJobQueueTask"
  command "#{base_path}/public/framework/sake dev/cron"
end
